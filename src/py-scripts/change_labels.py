...
ontoFile= '/Users/taravser/Documents/My_papers/CoLAO/colao/src/ontology/colao-edit.owl'
saveFile= '/Users/taravser/Documents/My_papers/CoLAO/colao/src/ontology/colao-edit-2.owl'
onto = get_ontology(ontoFile).load(reload_if_newer=True, reload=True)
obo = onto.get_namespace("http://purl.obolibrary.org/obo/")
...
found_terms = onto.search(label='cuticle of*', iri = '*COLAO*')
len(found_terms)

filename = '/Users/taravser/Documents/My_papers/AISM/GitHub/aism/src/py-scripts/found_terms_colao.txt'
i=1
with open(filename, 'w') as f:
    for term in found_terms:
        old_label = term.label.first()
