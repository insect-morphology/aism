These notes are for the EDITORS of aism
...
Make sure you have an ID range in the [idranges file](aism-idranges.owl)

If you do not have one, get one from the maintainer of this repo.

The editors version is [aism-edit.owl](aism-edit.owl)

** DO NOT EDIT aism.obo OR aism.owl in the top level directory **

[../../aism.owl](../../aism.owl) is the release version

To edit, open the file in Protege. First make sure you have the repository cloned, see [the GitHub project](https://github.com/obophenotype/anatomy_ontology_of_insect_skeletomuscular_system) for details.
 ...
 * [aism-idranges.owl](aism-idranges.owl)
...
There are two ways to include new classes in an import module
 ...
 2. Add to the imports/aism_terms.txt file
...
Note: the aism_terms.txt file may include 'starter' classes seeded from
...
This generates derived files such as aism.owl and aism.obo and places
 ...
 * https://github.com/obophenotype/anatomy_ontology_of_insect_skeletomuscular_system/releases
 * https://github.com/obophenotype/anatomy_ontology_of_insect_skeletomuscular_system/releases/new
...
what is in the `owl:versionIRI` of the derived aism.owl (`data-version` in
aism.obo). This will be today's date.
 ...
 * http://purl.obolibrary.org/obo/aism.owl <-- current ontology PURL
 * http://purl.obolibrary.org/obo/aism/releases/YYYY-MM-DD.owl <-- change to the release you just made

For questions on this contact Chris Mungall or email obo-admin AT obofoundry.org

# Travis Continuous Integration System

Check the build status here: [![Build Status](https://travis-ci.org/obophenotype/anatomy_ontology_of_insect_skeletomuscular_system.svg?branch=master)](https://travis-ci.org/obophenotype/anatomy_ontology_of_insect_skeletomuscular_system)

Note: if you have only just created this project you will need to authorize travis for this repo.

 1. Go to [https://travis-ci.org/profile/obophenotype](https://travis-ci.org/profile/obophenotype)
 2. click the "Sync account" button
 3. Click the tick symbol next to anatomy_ontology_of_insect_skeletomuscular_system
