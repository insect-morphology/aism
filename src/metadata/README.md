 ...
 * [aism.yml](aism.yml)
     * Determines how your purl.obolibrary.org/obo/aism/ redirects will be handled
     ...
     * Paste in the contents of [aism.yml](aism.yml)
 ...
 * [aism.md](aism.md)
     ...
     * Paste in the contents of [aism.md](aism.md)
     * Click "Commit new file"
     * IMPORTANT: remember to make a pull request
     * An OBO admin will merge your Pull Request *providing it meets the requirements of the OBO library*
