...
- **Does the term already exist?** Before submitting suggestions for new ontology terms, check whether the term exist, either as a primary term or a synonym term. You can search using [OLS](http://www.ebi.ac.uk/ols/ontologies/aism)
...
On behalf of the Anatomy Ontology of Insect Skeletomuscular System editorial team, Thanks!